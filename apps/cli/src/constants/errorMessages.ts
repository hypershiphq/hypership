...
export const ERROR_MESSAGES = {
  ...
  'Failed to retrieve token': `${color.bgRed(color.white(' Unauthorized: '))} Your current session has expired. Please login again using ${color.underline(color.bold('`hypership login`'))}`,
