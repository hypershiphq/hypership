...
interface ButtonSignInGitHubProps {
  buttonLabel: string;
  onClick?: () => void;
...
const ButtonSignInGitHub: React.FC<ButtonSignInGitHubProps> = ({
  buttonLabel,
  onClick,
  type = "button",
  unstyled = false,
  ...
  return (
    ...
    >
      {loading || signingIn ? (
        ...
        <>
          <div
            style={{ position: "absolute", left: "1rem", marginTop: "0.2rem" }}
          >
            <svg
              width="22"
              height="22"
...
export default ButtonSignInGitHub;
