  ...
  return (
    <div className="hypership-container">
      <div className="w-full">
        ...
        <form
          className="hypership-form bg-white dark:bg-transparent w-full p-6 rounded-lg border border-gray-200 dark:border-gray-800 shadow-sm hover:shadow-md transition-all duration-300"
